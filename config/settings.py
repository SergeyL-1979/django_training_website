...
SECRET_KEY = 'django-insecure-9n8l9d@e_h-aztj)wjzng^3%@m@0)g+1$#-&=aaig2@k!dp(0_'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1:8001', '132.145.77.107']

# Application definition

INSTALLED_APPS = [
    # добавили название созданного приложения
